...
def main(listfile=None, oname='all', inputfile_basename=None):
    
    if listfile:
        listfile = open(listfile, 'r')
        list_basename_files = listfile.read().splitlines()
        ohandle=open('%s.i_energy.summary.txt' % oname, 'w')
...
if __name__=="__main__":
    ...
    parser.add_argument('-o','--oname', dest='oname', help='output file names')
